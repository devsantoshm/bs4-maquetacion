      ...
      <div class="modal-body">
        <div class="row">
          ...
          <div class="col-md-4 text-center">
            <img src="images/servicio-1.svg" alt="" width="200" class="img-fluid">
          </div>
        </div>
      </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
          ...
          <div class="col-md-4 text-center">
            <img src="images/servicio-2.svg" alt="" width="200" class="img-fluid">
          </div>
        </div>
      </div>
      <div class="modal-footer">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
          ...
          <div class="col-md-4 text-center">
            <img src="images/servicio-3.svg" alt="" width="200" class="img-fluid">
          </div>
        </div>
      </div>
      <div class="modal-footer">
